...
public class SymbolGraphUndirected implements SymbolGraph{
    ...
    public SymbolGraphUndirected(String fileName, String delimiter){
        ht = new HashTable<>();
        ...
        try {
            ...
            throw new IllegalArgumentException("No path: " + fileName);
        }
    }
